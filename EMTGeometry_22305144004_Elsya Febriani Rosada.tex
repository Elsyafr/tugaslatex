...
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-001.png}
\begin{eulercomment}
Hitung luas ABC:
...
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-003.png}
\begin{eulercomment}
...
\end{euleroutput}
\begin{eulercomment}
Sekarang akan digambar lingkaran dalam segitiga ABC.\\
Titik pusat lingkaran dalam adalah titik potong garis-garis bagi
sudut.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-004.png}
...
>plotSegment(L,Q,"c"):
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-005.png}
\begin{eulercomment}
3.)
\end{eulercomment}
\begin{eulerprompt}
...
>color(3); plotLine(k):
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-006.png}
\begin{eulerprompt}
>plotSegment(P,L,"r"):
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-007.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-019.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-021.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-022.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-032.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-037.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
Ada juga metode Lagrange, memaksimalkan H (a, b, c) \textasciicircum{} 2 terhadap a + b
+ d = d.
\end{eulercomment}
\begin{eulerprompt}
...
\begin{eulerformula}
\[
\left[ \left[ \frac{b^2+a^2-1}{2\,a} , \frac{b^2+a^2}{2\,a} , 
 \frac{b^2+a^2-16}{2\,a} \right]  , \left[ \frac{\sqrt{-b^4+2\,a^2\,b
 ^2+2\,b^2-a^4+2\,a^2-1}}{2\,a} , \frac{\sqrt{-b^4+2\,a^2\,b^2-a^4}}{
 2\,a} , \frac{\sqrt{-b^4+2\,a^2\,b^2+32\,b^2-a^4+32\,a^2-256}}{2\,a}
  \right]  \right] 
\]
\end{eulerformula}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-045.png}
\begin{eulercomment}
Plot segmennya.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-046.png}
\begin{eulercomment}
...
\begin{euleroutput}
  Maxima said:
  part: invalid index of list or matrix.
  #0: lineIntersection(g=[[-(-b^2-a^2+1)/(2*a),-(-b^2-a^2)/(2*a),-(-b^2-a^2+16)/(2*a)],[sqrt(-b^4+2*a^2*b^2+2*b^2-a^4+2*a^2-1...,h=[-a,0,-a^2/2])
   -- an error. To debug this try: debugmode(true);
...
\begin{euleroutput}
  ...
  Error in:
  ... eWithCenter(mxmeval("U"),mxmeval("distance(U,C)"))): ...
                                                       ^
\end{euleroutput}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
untuk radius. Kami dapat memeriksa, apakah ini benar dengan Maxima.
Maxima akan memfaktorkannya hanya jika kita mengkuadratkannya.
\end{eulercomment}
\begin{eulerprompt}
...
\begin{eulerformula}
\[
\left[ -\frac{4\,a^2\,b^2}{\left(b-a-1\right)\,\left(b-a+1\right)\,
 \left(b+a-1\right)\,\left(b+a+1\right)} , 0 , -\frac{64\,a^2\,b^2}{
 \left(b-a-4\right)\,\left(b-a+4\right)\,\left(b+a-4\right)\,\left(b+
 a+4\right)} \right] 
\]
\end{eulerformula}
...
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-049.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-056.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-059.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-061.png}
\begin{eulercomment}
Teorinya mengatakan bahwa MH = 2 * MO. Kita perlu menyederhanakan
dengan radcan untuk mencapai ini.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-066.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-068.png}
\begin{eulercomment}
...
Adding the first solution to the plot show, that it is indeed the path
we are looking for. The theory tells us that it is a rotated parabola.
\end{eulercomment}
\begin{eulerprompt}
>plot2d(&rhs(akar[1]),add=1):
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-069.png}
\begin{eulerprompt}
...
>insimg(30);
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-076.png}
\begin{eulercomment}
Tentu saja,
...
\end{euleroutput}
\begin{eulercomment}
Hukum kosinus dari trgonometri klasik diterjemahkan menjadi "hukum
silang" berikut.
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-089.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-115.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-120.png}
\begin{eulercomment}
...
Kami menggunakan teorema sinus di segitiga APC. Teorema ini menyatakan
bahwa
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-125.png}
\begin{eulercomment}
...
akor b adalah setengah dari sudut tengah.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-129.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-130.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-131.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-132.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-133.png}
\begin{eulercomment}
\end{eulercomment}
\eulersubheading{Three points}
\begin{eulercomment}
Sekarang hal-hal menjadi kurang sederhana: Sedikit kurang diketahui
bahwa MA + MB + MC mencapai minimumnya pada satu titik bidang tetapi
untuk menentukannya kurang sederhana:
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-134.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-4,xmax=1,ymin=-2,ymax=2,hue=1,title="The minimum is on A");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-135.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-136.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-2,xmax=2,ymin=-2,ymax=2,hue=1,title="The Fermat point");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-137.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-138.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],points=1,add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-139.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-140.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],add=1,color=12,points=1);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-141.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-142.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-146.png}
...
>povend();
\end{eulerprompt}
\eulerimg{28}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-147.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-148.png}
...
\end{euleroutput}
\begin{eulerttcomment}
 1Sudut segitiga melebihi 80° pada bola.
\end{eulerttcomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-149.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-150.png}
...
>plotSegment(A,B,""):
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-151.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-152.png}
\begin{eulerprompt}
>color(6); plotSegment(A,k,""); plotSegment(A,n,""); plotSegment(k,l,""); plotSegment(l,B,""); plotSegment(B,m,""); plotSegment(m,n,""):
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-153.png}
\eulersubheading{}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-154.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-155.png}
\eulersubheading{}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-156.png}
\eulersubheading{}
\begin{eulercomment}
...
>fcontour("d2",xmin=-2,xmax=2,ymin=-3,ymax=1,hue=1):
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-157.png}
\begin{eulercomment}
...
>plot3d("d2",xmin=-2,xmax=2,ymin=-3,ymax=1):
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-158.png}
\begin{eulercomment}
Batasan ke garis PQ
\end{eulercomment}
\begin{eulerprompt}
>plot2d("abs(x+1)+abs(x-1)",xmin=-3,xmax=3):
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-159.png}
\eulersubheading{}
\begin{eulercomment}
...
>fcontour("d2",xmin=-2,xmax=2,ymin=-3,ymax=1,hue=1):
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-160.png}
\begin{eulercomment}
Grafik yang lebih menarik
\end{eulercomment}
\begin{eulerprompt}
>plot3d("d2",xmin=-2,xmax=2,ymin=-3,ymax=1):
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-161.png}
\begin{eulerprompt}
>plot2d("abs(x+1)+abs(x-1)",xmin=-3,xmax=3):
\end{eulerprompt}
\eulerimg{27}{images/EMTGeometry_22305144004_Elsya Febriani Rosada-162.png}
\end{eulernotebook}
\end{document}
