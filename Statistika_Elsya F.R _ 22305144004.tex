...
\begin{document}
\begin{eulernotebook}
\eulerheading{MATERI STATISTIKA ---}
\begin{eulercomment}
...
\begin{eulercomment}
\eulerheading{EMT PADA MATERI STATISTIKA}
\begin{eulercomment}
Dalam buku catatan ini, kami mendemonstrasikan plot statistik utama,
pengujian, dan distribusi di Euler. Dimulai dengan beberapa statistik
deskriptif. Ini bukan pengantar statistik. Jadi, Anda mungkin
memerlukan beberapa latar belakang untuk memahami detailnya.
...
>boxplot(M):
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-001.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-002.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-003.png}
\eulersubheading{}
\eulerheading{TABEL STATISTIKA}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-004.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-005.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-006.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-009.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-010.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-011.png}
\begin{eulerformula}
\[
\text{normaldis(x,m,d)}=\int_{-\infty}^x \frac{1}{d\sqrt{2\pi}}e^{-\frac{1}{2 }(\frac{t-m}{d})^2}\ dt.
\]
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-014.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-015.png}
\begin{eulercomment}
...
>statplot(YT,BT1,"b"):
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-017.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-018.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-019.png}
\begin{eulercomment}
...
>  angle=30°,ccols=CP):
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-020.png}
\begin{eulercomment}
...
>shrinkwindow():
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-021.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-022.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-023.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-024.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-025.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-026.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-027.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-028.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-029.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-030.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-031.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-032.png}
...
>figure(0):
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-033.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-034.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-035.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-036.png}
\begin{eulercomment}
...
\end{eulerprompt}
\begin{euleroutput}
  [5,  12,  23,  50,  68,  97,  133,  144,  123,  123,  93,  64,  35,
  19,  8,  3]
\end{euleroutput}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-038.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-039.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-040.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-041.png}
\eulersubheading{}
\eulerheading{TEST}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-042.png}
\begin{eulerprompt}
>t=count(R,21);
\end{eulerprompt}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-043.png}
\begin{eulercomment}
Hapus datanya.
\end{eulercomment}
\begin{eulerprompt}
...
>statplot(u,f,"h"):
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-044.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-045.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-046.png}
\eulerheading{Daftar}
\begin{eulercomment}
...
\begin{euleroutput}
  A,B,C
  0.3491688434404096,0.7398845366622254,0.8226563357402517
  0.3728495974523089,0.6209769215355806,0.906401213279042
  0.2737868429496333,0.03457116705297921,0.3357303312686636
...
\begin{euleroutput}
           A         B         C
     0.34917   0.73988   0.82266
     0.37285   0.62098    0.9064
     0.27379   0.03457   0.33573
\end{euleroutput}
\begin{eulercomment}
...
\end{eulerprompt}
\begin{euleroutput}
  0.5780511177770538,0.849418085627508,0.9486955747190509
  0.2962412914170464,0.8492752044407615,0.368272695365911
  0.2994847886526059,0.2701804763476087,0.3564511683296176
...
\end{eulerprompt}
\eulerimg{27}{images/Statistika_Elsya F.R _ 22305144004-047.png}
\begin{eulercomment}
...
\begin{euleroutput}
  M = [ ..
  0.229779724744743, 0.7067405004393973;
  0.0601450750196033, 0.1751821194265411];
\end{euleroutput}
\begin{eulercomment}
...
\end{eulerprompt}
\begin{euleroutput}
  [0.60531,  0.11147,  0.30825,  0.23873,  0.22388]
\end{euleroutput}
\end{eulernotebook}
\end{document}
